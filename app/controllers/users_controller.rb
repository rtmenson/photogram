class UsersController < ApplicationController
  def index
    ...
    @users = @q.result(:distinct => true).includes(:likes, :photos, :sent_friend_requests, :received_friend_requests, :liked_photos, :leaders, :followers).page(params[:page]).per(10)
